/* Cafe 0.0.96 Wed Apr 03 2013 18:41:31 GMT+0300 (EEST) */
...
(function() {
  ...
  get_namespaced_logger = function(log_ns) {
    if (LOGCFG) {
      LOGCFG.ns || (LOGCFG.ns = {});
      if (!LOGCFG.ns.hasOwnProperty(log_ns)) {
...
/*ZB:  /calcbl */
'calcbl': function(exports, require, module) {(function() {
(function() {
  var OPS, debug, dispatch_impl, error, info, partial, pubsubhub, warn, _ref, _ref1,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
    ...
    protocols: {
      definitions: {
        Calc: [
          ...
          ], ['push!', ['v']], ['do-calc', []], ['reset!', []], ['on-stack-change', ['f']], ['render-stack', ['s']]
        ]
      },
      implementations: {
        Calc: function(node, _arg) {
          var $stack$, pub, push, sub;
          ...
          return {
            'push!': push,
            'do-calc': function() {
              var args, result, v, _results;

              args = [];
              _results = [];
              while (v = $stack$.shift()) {
                if (__indexOf.call(Object.keys(OPS), v) >= 0) {
                  result = OPS[v](args);
                  push(result);
                  break;
                } else {
                  _results.push(args.push(v));
                }
              }
              return _results;
            },
            'on-stack-change': partial(sub, 'on-stack-change'),
            'render-stack': function(s) {
              return s.join(' ');
            },
            'reset!': function() {
              $stack$ = [];
...
(function() {
  module.exports = {
    run: function() {
      var dispatch_impl, idom, info, qm;
